    ...
    try:
        while True:
            ...
            for candidate in candidates:
                ...
                hr_id = hr_manager.get("id") if hr_manager else main_manager_id
                hr_name = ""
...
def main():
    ...
    fieldnames = ["MainManagerId", "MainManagerName", "AgencyId", "AgencyName", "PoleId", "PoleName", "id", "FirstName", "LastName", "Availability", "UpdateDate", "State", "HrResponsibleId", "HrResponsibleName"]
